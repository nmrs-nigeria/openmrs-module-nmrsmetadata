package org.openmrs.module.nmrsmetadata.page;
 ...
 */
@Component
public class NigeriaCEMRLoginPageRequestMapper implements PageRequestMapper {
	...
	public boolean mapRequest(PageRequest request) {
		if (request.getProviderName().equals("referenceapplication")) {
			if (request.getPageName().equals("login")) {
				...
				request.setPageNameOverride("nigeriaCEMRLogin");
